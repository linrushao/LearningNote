...
![单机MySQL](Redis.assets/%E5%8D%95%E6%9C%BAMySQL.png)
...
![数据库添加缓存](Redis.assets/%E6%95%B0%E6%8D%AE%E5%BA%93%E6%B7%BB%E5%8A%A0%E7%BC%93%E5%AD%98.png)
...
![MySQL集群](Redis.assets/MySQL%E9%9B%86%E7%BE%A4.png)
...
# 下载地址http://download.redis.io/releases/redis-3.2.11.tar.gz
# 2、上传到Linux服务器并解压，进入到Redis根目录下。解压redis源码包
...
# 编译并安装
make && make install
# 报错，原因是没有安装jemalloc内存分配器，可以安装jemalloc或直接输入
...
/usr/local/bin
# 在所有机器的/usr/local/下创建一个redis目录，然后拷贝redis自带的配置文件redis.conf到/usr/local/redis
...
![jedis连接池问题](Redis.assets/jedis%25E8%25BF%259E%25E6%258E%25A5%25E6%25B1%25A0%25E9%2597%25AE%25E9%25A2%2598.png)
...
![RDB基本介绍](Redis.assets/RDB%E5%9F%BA%E6%9C%AC%E4%BB%8B%E7%BB%8D.png)
...
![主从复制](Redis.assets/%E4%B8%BB%E4%BB%8E%E5%A4%8D%E5%88%B6.png)
...
![哨兵模式](Redis.assets/%E5%93%A8%E5%85%B5%E6%A8%A1%E5%BC%8F.png)
